...
def get_new_arrivals():
    return [
        ...
        {"id": 2, "name": "Thunder 2000", "price": 3720, "rating": 3.0, "image": "truck2.jpg", "old_price": "260 Million"},
        {"id": 3, "name": "MAN TGS 220", "price": 2800, "rating": 4.0, "image": "truck3.jpg", "old_price": None},
        {"id": 4, "name": "Blue V8 500 GIGA", "price": 2000, "rating": 4.8, "image": "truck4.jpg", "old_price": "160 Million"},
    ]

def get_top_selling():
    return [
        {"id": 5, "name": "MAN TGX 220", "price": 3300 , "rating": 5.0, "image": "truck5.jpg", "old_price": "232 Million"},
...
def format_price_display(price):
    """Format price integer to display string with Million suffix"""
    if isinstance(price, str):
        return price
    return f"{price} Million"